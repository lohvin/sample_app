...
# /build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c -m32 -msoft-float
...
foo:
	...
	call	mcount
#APP
# 11 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_ax $44 offsetof(struct sigcontext, ax)	#
# 0 "" 2
# 12 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_bx $32 offsetof(struct sigcontext, bx)	#
# 0 "" 2
# 13 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_cx $40 offsetof(struct sigcontext, cx)	#
# 0 "" 2
# 14 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_dx $36 offsetof(struct sigcontext, dx)	#
# 0 "" 2
# 15 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_si $20 offsetof(struct sigcontext, si)	#
# 0 "" 2
# 16 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_di $16 offsetof(struct sigcontext, di)	#
# 0 "" 2
# 17 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_bp $24 offsetof(struct sigcontext, bp)	#
# 0 "" 2
# 18 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_sp $28 offsetof(struct sigcontext, sp)	#
# 0 "" 2
# 19 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_SIGCONTEXT_ip $56 offsetof(struct sigcontext, ip)	#
# 0 "" 2
# 20 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->
# 0 "" 2
# 22 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_x86 $0 offsetof(struct cpuinfo_x86, x86)	#
# 0 "" 2
# 23 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_x86_vendor $1 offsetof(struct cpuinfo_x86, x86_vendor)	#
# 0 "" 2
# 24 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_x86_model $2 offsetof(struct cpuinfo_x86, x86_model)	#
# 0 "" 2
# 25 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_x86_mask $3 offsetof(struct cpuinfo_x86, x86_mask)	#
# 0 "" 2
# 26 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_hard_math $6 offsetof(struct cpuinfo_x86, hard_math)	#
# 0 "" 2
# 27 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_cpuid_level $20 offsetof(struct cpuinfo_x86, cpuid_level)	#
# 0 "" 2
# 28 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_x86_capability $24 offsetof(struct cpuinfo_x86, x86_capability)	#
# 0 "" 2
# 29 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->CPUINFO_x86_vendor_id $64 offsetof(struct cpuinfo_x86, x86_vendor_id)	#
# 0 "" 2
# 30 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->
# 0 "" 2
# 32 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->TI_sysenter_return $60 offsetof(struct thread_info, sysenter_return)	#
# 0 "" 2
# 33 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->TI_cpu $16 offsetof(struct thread_info, cpu)	#
# 0 "" 2
# 34 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->
# 0 "" 2
# 36 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EBX $0 offsetof(struct pt_regs, bx)	#
# 0 "" 2
# 37 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_ECX $4 offsetof(struct pt_regs, cx)	#
# 0 "" 2
# 38 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EDX $8 offsetof(struct pt_regs, dx)	#
# 0 "" 2
# 39 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_ESI $12 offsetof(struct pt_regs, si)	#
# 0 "" 2
# 40 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EDI $16 offsetof(struct pt_regs, di)	#
# 0 "" 2
# 41 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EBP $20 offsetof(struct pt_regs, bp)	#
# 0 "" 2
# 42 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EAX $24 offsetof(struct pt_regs, ax)	#
# 0 "" 2
# 43 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_DS $28 offsetof(struct pt_regs, ds)	#
# 0 "" 2
# 44 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_ES $32 offsetof(struct pt_regs, es)	#
# 0 "" 2
# 45 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_FS $36 offsetof(struct pt_regs, fs)	#
# 0 "" 2
# 46 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_GS $40 offsetof(struct pt_regs, gs)	#
# 0 "" 2
# 47 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_ORIG_EAX $44 offsetof(struct pt_regs, orig_ax)	#
# 0 "" 2
# 48 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EIP $48 offsetof(struct pt_regs, ip)	#
# 0 "" 2
# 49 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_CS $52 offsetof(struct pt_regs, cs)	#
# 0 "" 2
# 50 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_EFLAGS $56 offsetof(struct pt_regs, flags)	#
# 0 "" 2
# 51 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_OLDESP $60 offsetof(struct pt_regs, sp)	#
# 0 "" 2
# 52 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->PT_OLDSS $64 offsetof(struct pt_regs, ss)	#
# 0 "" 2
# 53 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->
# 0 "" 2
# 55 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->IA32_RT_SIGFRAME_sigcontext $164 offsetof(struct rt_sigframe, uc.uc_mcontext)	#
# 0 "" 2
# 56 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
	
->
# 0 "" 2
# 59 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets_32.c" 1
...
common:
	...
	call	mcount
#APP
# 31 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->
# 0 "" 2
# 32 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->TI_flags $8 offsetof(struct thread_info, flags)	#
# 0 "" 2
# 33 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->TI_status $12 offsetof(struct thread_info, status)	#
# 0 "" 2
# 34 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->TI_addr_limit $24 offsetof(struct thread_info, addr_limit)	#
# 0 "" 2
# 35 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->TI_preempt_count $20 offsetof(struct thread_info, preempt_count)	#
# 0 "" 2
# 37 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->
# 0 "" 2
# 38 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->crypto_tfm_ctx_offset $48 offsetof(struct crypto_tfm, __crt_ctx)	#
# 0 "" 2
# 40 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->
# 0 "" 2
# 41 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->pbe_address $0 offsetof(struct pbe, address)	#
# 0 "" 2
# 42 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->pbe_orig_address $4 offsetof(struct pbe, orig_address)	#
# 0 "" 2
# 43 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->pbe_next $8 offsetof(struct pbe, next)	#
# 0 "" 2
# 46 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->
# 0 "" 2
# 47 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PARAVIRT_enabled $8 offsetof(struct pv_info, paravirt_enabled)	#
# 0 "" 2
# 48 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PARAVIRT_PATCH_pv_cpu_ops $16 offsetof(struct paravirt_patch_template, pv_cpu_ops)	#
# 0 "" 2
# 49 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PARAVIRT_PATCH_pv_irq_ops $180 offsetof(struct paravirt_patch_template, pv_irq_ops)	#
# 0 "" 2
# 50 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PV_IRQ_irq_disable $8 offsetof(struct pv_irq_ops, irq_disable)	#
# 0 "" 2
# 51 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PV_IRQ_irq_enable $12 offsetof(struct pv_irq_ops, irq_enable)	#
# 0 "" 2
# 52 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PV_CPU_iret $148 offsetof(struct pv_cpu_ops, iret)	#
# 0 "" 2
# 53 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PV_CPU_irq_enable_sysexit $136 offsetof(struct pv_cpu_ops, irq_enable_sysexit)	#
# 0 "" 2
# 54 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PV_CPU_read_cr0 $12 offsetof(struct pv_cpu_ops, read_cr0)	#
# 0 "" 2
# 55 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->PV_MMU_read_cr2 $0 offsetof(struct pv_mmu_ops, read_cr2)	#
# 0 "" 2
# 59 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->
# 0 "" 2
# 60 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->XEN_vcpu_info_mask $1 offsetof(struct vcpu_info, evtchn_upcall_mask)	#
# 0 "" 2
# 61 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->XEN_vcpu_info_pending $0 offsetof(struct vcpu_info, evtchn_upcall_pending)	#
# 0 "" 2
# 64 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->
# 0 "" 2
# 65 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->BP_scratch $484 offsetof(struct boot_params, scratch)	#
# 0 "" 2
# 66 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->BP_loadflags $529 offsetof(struct boot_params, hdr.loadflags)	#
# 0 "" 2
# 67 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->BP_hardware_subarch $572 offsetof(struct boot_params, hdr.hardware_subarch)	#
# 0 "" 2
# 68 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
	
->BP_version $518 offsetof(struct boot_params, hdr.version)	#
# 0 "" 2
# 69 "/build/buildd/linux-3.2.0/arch/x86/kernel/asm-offsets.c" 1
